                ...
                (o = [
                    {
                        ...
                        value: function () {
                            ...
                            t &&
                                this.$triggerEle &&
                                (i.setStyle(t, "zIndex", this.zIndex),
                                this.setPosition());
                        },
                    },
                    {
                                ...
                                (this.enterDelayTimeout = setTimeout(
                                    function () {
                                        ...
                                        i.show(t.$popperEle, "inline-flex"),
                                            ...
                                            (t.showDurationTimeout = setTimeout(
                                                function () {
                                                    "function" ==
                                                        typeof t.afterShowCallback &&
                                    ...
                                    function () {
                                        if (t.$popperEle) {
                                            ...
                                            i.setStyle(
                                                ...
                                                (t.hideDurationTimeout =
                                                    setTimeout(function () {
                                                        i.hide(t.$popperEle),
                                                            "function" ==
                                                                typeof t.afterHideCallback &&
                                                                t.afterHideCallback(
                                                                    o
                                                                );
                                                    }, a));
                                ...
                                if (
                                    ...
                                    o && o.remove(),
                                        ...
                                        (p = {
                                            ...
                                            transitionDistance:
                                                s.transitionDistance,
                                            zIndex: s.zIndex,
                                        }),
                                        (l = new PopperComponent(p)).show(),
                                        (a = i.getScrollableParents(n)).forEach(
                                            function (t) {
